  ...
  return (
    <div className="min-h-screen bg-white text-black flex items-center">
      <div className="max-w-xl mx-auto w-full px-8">
        <h1 className="text-4xl font-bold mb-2">Bible Reader</h1>
        ...
        <div className="space-y-6">
          {/* BOOK */}
          <div>
            <label htmlFor="book" className="block mb-1 font-medium">
              Book
            </label>

            <select
              id="book"
              className="border border-gray-300 px-3 py-3 w-full rounded focus:outline-none focus:ring-2 focus:ring-black"
              value={book}
          ...
          {/* CHAPTER */}
          <div>
            <label htmlFor="chapter" className="block mb-1 font-medium">
              Chapter
            </label>
